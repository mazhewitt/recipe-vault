...
The Frontend Modules capability provides a modular JavaScript architecture using ES modules for maintainable frontend code organization.
...
### Maintainability
- Each module SHOULD be under 400 lines of code
- Module responsibilities SHOULD be documented in code comments
- Module boundaries SHOULD be clear enough that a developer can quickly locate feature-specific code

### Performance
- Initial module load SHOULD complete within 500ms on a modern connection
- Module loading SHOULD leverage HTTP/2 multiplexing for efficient parallel downloads
